                            ...
                            <div class="col-md-5">
                                <ul class="list-group">
                                    ...
                                    <li class="list-group-item">
                                        ...
                                        <div class="progress">
                                          <div class="progress-bar <?php echo esc_attr($class); ?>" data-appear-progress-animation="<?php echo esc_attr($cause_percentage); ?>%" data-appear-animation-delay="200"></div>
                                        </div>
                                    </li>
                                  	<li class="list-group-item"> <span class="badge"><?php echo imic_get_currency_symbol(get_option('paypal_currency_options')). esc_attr($cause_amount); ?></span> <?php _e('Amount Needed','framework'); ?> </li>
                                  	<?php } 
									if(!empty($cause_received_amount)){
									?>
                                  	<li class="list-group-item"> <span class="badge"><?php echo imic_get_currency_symbol(get_option('paypal_currency_options')). esc_attr($cause_received_amount); ?></span> <?php _e('Collected yet','framework'); ?> </li>
                                    <?php }
									if(!empty($cause_received_amount)&&!empty($cause_amount)){ ?>
                                  	<li class="list-group-item"> <span class="badge accent-bg"><?php echo esc_attr($cause_percentage) .'%'; ?></span> <?php _e('Percentile','framework'); ?> </li>
                                    <?php }
									//Cause Donation Days left
                                  	...
                                  	<li class="list-group-item"> <span class="badge"><?php echo esc_attr($cause_date_msg); ?></span> <?php _e('Days left to achieve target','framework'); ?></li><?php } else { ?>
