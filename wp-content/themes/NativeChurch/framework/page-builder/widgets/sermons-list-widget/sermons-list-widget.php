...
class Sermons_List_Widget extends SiteOrigin_Widget {
	function __construct() {
		...
		parent::__construct(
			'sermons-list-widget',
			__('Sermons List Widget', 'framework'),
			array(
				'description' => __('A widget to show sermons list/grid view.', 'framework'),
			...
			array(
				...
				'allpostsbtn' => array(
					'type' => 'text',
					'label' => __('All sermons button text', 'framework'),
					'default' => __('All Sermons', 'framework'),
					'description' => __('This button will be displayed only if the widget has title.', 'framework'),
				),

				'allpostsurl' => array(
					'type' => 'link',
					'label' => __('All sermons button URL', 'framework'),
					'description' => __('This button will be displayed only if the widget has title.', 'framework'),
				),

				'categories' => array(
					'type' => 'text',
					'label' => __('Categories (Enter comma separated sermon category slugs)', 'framework'),
				),
				'number_of_posts' => array(
					'type' => 'slider',
					'label' => __( 'Number of Sermons to show', 'framework' ),
					'default' => 4,
					'min' => 1,
					'max' => 250,
					'integer' => true,
		        ...
		        'pagination' => array(
                    'label' => __('Enable/Disable Pagination', 'framework'),
                    'desc' => __("Select Enabled to show pagination.", 'framework'),
                    'type' => 'select',
                    'options' => array(
		                '1' => __('Enabled', 'framework'),
		                '0' => __('Disabled','framework'),
                    ),
	                'std' => 0,
                ),
				'show_post_meta' => array(
					'type' => 'checkbox',
					'default' => true,
					'label' => __('Show post meta like post date, pastor name?', 'framework'),
				),
