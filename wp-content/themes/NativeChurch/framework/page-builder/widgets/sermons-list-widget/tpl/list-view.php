...
?>
<?php query_posts(array('post_type' => 'sermons', 'sermons-category' => '' . $the_categories . '', 'posts_per_page' => $numberPosts, 'paged' => get_query_var('paged')));
if (have_posts()) :
					...
					<div class="row">
						<div class="col-md-9 col-sm-9">
							...
							if ($instance['show_post_meta']) {
								...
								$pastor = esc_html__('Pastor', 'framework');
							...
							if (!empty($attach_pdf)) {
								...
								echo '<a href="' . $download_dir . 'download/download.php?file=' . $attach_pdf . '" data-placement="top" data-toggle="tooltip" data-original-title="' . __('Download PDF', 'framework') . '" rel="tooltip"><i class="fa fa-book"></i></a>';
							}
							echo '</div>
</div>';
							echo '</header>
