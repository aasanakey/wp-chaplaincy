...
if($instance['filters']){ ?>
        ...
        <?php foreach($gallery_cats as $gallery_cat) { ?>
            <li data-option-value=".format-<?php echo esc_attr($gallery_cat->slug); ?>"><a href="#"><i class="fa <?php echo esc_attr($gallery_cat->description); ?>"></i> <span><?php echo esc_attr($gallery_cat->name); ?></span></a></li>
        <?php } ?>
        </ul>
