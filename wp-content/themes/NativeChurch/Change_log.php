...
17 August 2019 - Version 3.3.1
    NEW! Option to choose grid column in staff page template
    UPDATED! Revolution Slider Plugin
    UPDATED! NativeChurch Core Plugin
    UPDATED! Theme\'s js libraries
    UPDATED! Events calendar json feed
...
21 May 2019 - Version 3.2.1
	NEW! Option to sort staff posts by title in page template & widget
	UPDATED! iPray Plugin
	UPDATED! NativeChurch Core plugin
	FIXED! A bug with megamenu system of the theme
	FIXED! Footer copyrights text not showing
	FIXED! A bug with event section on Homepage template 3
	
09 May 2019 - Version 3.2
	...
	FIXED! Error 500 with sermons posts type feed in WP version: 5.1+
	FIXED! Some styling bugs
