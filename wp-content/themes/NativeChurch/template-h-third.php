...
if ($upcoming_events_category) {
    $events_objects = nativechurch_get_term_objects(explode(',', $upcoming_events_category));
        ...
        <div class="notice-bar">
            <div class="container">
                ...
                if ($imic_going_on_events == 2) {
                    $saved_future_events = get_option('nativechurch_saved_future_events_' . $site_lang);
                    if ($saved_future_events) {
                        $event_add_going = $saved_future_events;
                    } else {
                        $event_add_going = imic_recur_events('future', 'nos', '', '', 'save');
                    }
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6 col-xs-6 notice-bar-event-title">
                    ...
                    if ($event_category != '') {
                        ...
                        $saved_future_events = get_option('nativechurch_saved_future_events_' . $site_lang);
                        if ($saved_future_events) {
                            $specific_event_data = $saved_future_events;
                        } else {
                            $specific_event_data = imic_recur_events('future', 'nos', '', '', 'save');
                        }
                        if ($event_category) {
                            $events_objects = nativechurch_get_term_objects(explode(',', $event_category));
                            $specific_event_data = array_intersect($specific_event_data, $events_objects);
                        }
...
<div class="main" role="main">
    <div id="content" class="content full">
        <div class="container">
            ...
            if ($imic_recent_events_area == 1) {
                ...
                if (!empty($new_events)) {
                    ...
                    $no_upcoming_events_msg = esc_html__('No Upcoming Events Found', 'framework');
                }
                $wp_query = clone $temp_wp_query;
                $pages_e = get_pages(array(
                    'meta_key' => '_wp_page_template',
                ...
                <div class="listing">
                    <header class="listing-header">
                        ...
                        if (!empty($imic_custom_all_event_url) || !empty($pages_e[0]->ID)) {
                            ...
                            $imic_custom_all_event_url = !empty($imic_custom_all_event_url) ? $imic_custom_all_event_url : get_permalink($pages_e[0]->ID);
                            echo '<a href="' . $imic_custom_all_event_url . '" class="btn btn-primary pull-right push-btn">' . esc_html__('All Events', 'framework') . '</a>';
                        }
                        $imic_custom_upcoming_events_title = get_post_meta($home_id, 'imic_custom_upcoming_events_title', true);
                        $imic_custom_upcoming_events_title = !empty($imic_custom_upcoming_events_title) ? $imic_custom_upcoming_events_title : esc_html__('Upcoming Events', 'framework');
                        ...
                        <div class="<?php echo esc_attr($pageOptions['class']); ?>" id="content-col">
                            <div class="listing post-listing">
                                <header class="listing-header">
                                    ...
                                    $imic_custom_latest_news_title = !empty($imic_custom_latest_news_title) ? $imic_custom_latest_news_title : esc_html__('Latest News', 'framework');
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="<?php echo esc_attr($class); ?>">
                                                        <div class="post-title">
                                                            ...
                                                            echo '</div>';
                                                            echo '<p><a href="' . get_permalink() . '" class="btn btn-primary">' . esc_html__('Continue reading', 'framework') . '<i class="fa fa-long-arrow-right"></i></a></p>';
                                                            ?>
                                                        </div>
                                                    </div>
                                            </li>
        ...
        if (have_posts() && $imic_imic_galleries == 1) :
            ...
            ?>
            <div class="parallax parallax1 padding-tb100" style="background-image:url(<?php echo esc_url($large_src_i[0]); ?>)">
                <div class="container">
                    <div class="row">
                        <div class="col-md-3 hidden-sm hidden-xs">
                            <?php
                            $imic_custom_gallery_title = get_post_meta($home_id, 'imic_custom_gallery_title', true);
                            $imic_custom_gallery_title = !empty($imic_custom_gallery_title) ? $imic_custom_gallery_title : esc_html__('Updates from our gallery', 'framework');
                            ...
                            $imic_custom_more_galleries_title = !empty($imic_custom_more_galleries_title) ? $imic_custom_more_galleries_title : esc_html__('More Galleries', 'framework');
                    ...
                    <div class="listing">
                        <header class="listing-header">
                            ...
                            if (!empty($imic_all_sermon_url) || !empty($pages_s_albums[0]->ID)) {
                                ...
                                echo '<a href="' . $imic_all_sermon_url . '" class="btn btn-primary pull-right push-btn">' . esc_html__('All Albums', 'framework') . '</a>';
                            }
                            $imic_custom_albums_title = get_post_meta($home_id, 'imic_custom_albums_title', 'true');
                            $imic_custom_albums_title = !empty($imic_custom_albums_title) ? $imic_custom_albums_title : esc_html__('Latest Sermon Albums', 'framework');
                                    ...
                                    foreach ($sermonterms as $sermonterms_data) {
                                        ...
                                        <li class="col-md-3 col-sm-6">
                                            <div class="grid-item-inner">
                                                ...
                                                if (!empty($term_meta)) { ?>
                                                    <a href="<?php echo esc_url($term_link); ?>" class="album-cover">
                                                        <span class="album-image"><img src="<?php echo esc_url($term_meta); ?>" alt="Cover"></span>
                                                    </a>
                                                <?php
                                            }
                                            if (count($imic_sermons_url_array) > 0) {
                                                echo '<div class="label label-primary album-count">' . count($imic_sermons_url_array) . esc_html__(' videos', 'framework') . '</div>';
                                                echo '&nbsp';
                                            }
                                            if (count($imic_sermon_attach_full_audio_array) > 0) {
                                                echo '<div class="label label-primary album-count">' . count($imic_sermon_attach_full_audio_array) . esc_html__(' audios', 'framework') . '</div>';
                                            }
                                            ...
                                            if (is_wp_error($term_link)) {
                                                ...
                                                echo '<a class="btn btn-default btn-sm" href="' . $term_link . '" >' . esc_html__('Play ', 'framework') . '<i class="fa fa-play"></i></a>';
                                            }
                                            ?>
                                            </div>
                                        </li>
