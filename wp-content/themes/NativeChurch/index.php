...
<div class="container">
    <div class="row">
        <div class="<?php echo esc_attr($pageOptions['class']); ?> posts-archive" id="content-col">
            <?php
			if(!is_archive()){
                	...
                	<div class="row">';
                    	...
                    	echo '<h3><a href="' . get_permalink() . '">' . get_the_title() . '</a></h3>';
                   		echo '<span class="post-meta meta-data">
								...
								<span><i class="fa fa-user"></i>'. esc_html__(' Posted By: ','framework'). get_the_author_meta('display_name').'</span>
								<span><i class="fa fa-archive"></i>'.imic_custom_taxonomies_terms_links().'</span>
						<span>';
                    	comments_popup_link('<i class="fa fa-comment"></i>'.esc_html__('No comments yet','framework'), '<i class="fa fa-comment"></i>1', '<i class="fa fa-comment"></i>%', 'comments-link','');
                    echo'</span></span>';
