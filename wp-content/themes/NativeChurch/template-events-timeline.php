    ...
    <div class="row">
        <div class="col-md-<?php echo esc_attr($column_class); ?>" id="content-col">
            ...
            <ul class="timeline">
                ...
                $count_events = 0;
                $events_per_page = get_post_meta(get_the_ID(), 'imic_event_timeline_per_page', true);
                ...
                foreach ($new_events as $key => $value) {
                    ...
                    if ($month_check == 1) {
                        $month_tag = imic_global_month_name($key);
                    }
                    if ($month_check == 1) {
                        $tag = '<div class="timeline-badge">' . $month_tag . '<span>' . $year_tag . '</span></div>';
                    } else {
                        $tag = '';
                    }
                    $month_check++;
			...
			<?php echo pagination($set_total_pages, 4); ?>
        </div>
